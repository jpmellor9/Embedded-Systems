...
typedef enum {NONE=0, THREAD1=0b001, THREAD2=0b010, THREAD3 = 0b011, ALL =0b111} THREADHEALTH; 
uint16_t threadHealth = 0b000;
Mutex threadHealthLock;
void isAlive(THREADHEALTH th)
{
     if (threadHealthLock.trylock_for(5s) == true){
